...
public sealed class FieldBuilder : FieldInfo, _FieldBuilder
{
	...
	internal FieldBuilder(TypeBuilder typeBuilder, string fieldName, Type type, Type[] requiredCustomModifiers, Type[] optionalCustomModifiers, FieldAttributes attributes)
	{
		...
		m_fieldTok = TypeBuilder.DefineField(m_typeBuilder.GetModuleBuilder().GetNativeHandle(), typeBuilder.TypeToken.Token, fieldName, signature, length, m_Attributes);
	...
	public void SetMarshal(UnmanagedMarshal unmanagedMarshal)
	{
		...
		TypeBuilder.SetFieldMarshal(m_typeBuilder.GetModuleBuilder().GetNativeHandle(), GetToken().Token, array, array.Length);
	}
	...
	public void SetCustomAttribute(ConstructorInfo con, byte[] binaryAttribute)
	{
		...
		m_typeBuilder.ThrowIfCreated();
		TypeBuilder.DefineCustomAttribute(moduleBuilder, m_tkField.Token, moduleBuilder.GetConstructorToken(con).Token, binaryAttribute, toDisk: false, updateCompilerFlags: false);
	}
