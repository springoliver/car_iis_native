...
public class HijriCalendar : Calendar
{
	...
	private static int GetAdvanceHijriDate()
	{
		...
		try
		{
			registryKey = Registry.CurrentUser.InternalOpenSubKey("Control Panel\\International", writable: false);
		}
		...
		if (registryKey != null)
		{
			try
			{
				object obj = registryKey.InternalGetValue("AddHijriDate", null, doNotExpand: false, checkSecurity: false);
				if (obj == null)
				{
					return 0;
				}
