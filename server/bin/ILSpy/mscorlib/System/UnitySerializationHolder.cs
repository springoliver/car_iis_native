...
internal class UnitySerializationHolder : ISerializable, IObjectReference
{
	...
	public virtual object GetRealObject(StreamingContext context)
	{
		...
		case 4:
		{
			...
			return assembly.GetType(m_data, throwOnError: true, ignoreCase: false);
		}
		case 5:
		{
			if (m_data == null || m_data.Length == 0)
			...
			Assembly assembly = Assembly.Load(m_assemblyName);
			Module module = assembly.GetModule(m_data);
			if (module == null)
			{
				throw new SerializationException(Environment.GetResourceString("Serialization_UnableToFindModule", m_data, m_assemblyName));
			}
			return module;
		}
		case 6:
