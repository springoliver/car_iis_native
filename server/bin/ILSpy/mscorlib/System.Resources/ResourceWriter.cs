...
public sealed class ResourceWriter : IResourceWriter, IDisposable
{
	...
	public void Generate()
	{
		...
		try
		{
			...
			File.SetAttributes(text, FileAttributes.Temporary | FileAttributes.NotContentIndexed);
			stream = new FileStream(text, FileMode.Open, FileAccess.ReadWrite, FileShare.Read, 4096, FileOptions.DeleteOnClose | FileOptions.SequentialScan);
		}
