...
internal static class Win32Native
{
	...
	internal struct TimeZoneInformation(DynamicTimeZoneInformation dtzi)
	{
		[MarshalAs(UnmanagedType.I4)]
		public int Bias = dtzi.Bias;

		[MarshalAs(UnmanagedType.ByValTStr, SizeConst = 32)]
		public string StandardName = dtzi.StandardName;

		public SystemTime StandardDate = dtzi.StandardDate;

		[MarshalAs(UnmanagedType.I4)]
		public int StandardBias = dtzi.StandardBias;

		[MarshalAs(UnmanagedType.ByValTStr, SizeConst = 32)]
		public string DaylightName = dtzi.DaylightName;

		public SystemTime DaylightDate = dtzi.DaylightDate;

		[MarshalAs(UnmanagedType.I4)]
		public int DaylightBias = dtzi.DaylightBias;
	}
	...
	internal struct FILE_TIME(long fileTime)
	{
		internal uint ftTimeLow = (uint)fileTime;

		internal uint ftTimeHigh = (uint)(fileTime >> 32);
