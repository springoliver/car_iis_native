...
internal class EUCJPEncoding : DBCSCodePageEncoding
{
	...
	protected unsafe override string GetMemorySectionName()
	{
		...
		return string.Format(CultureInfo.InvariantCulture, "CodePage_{0}_{1}_{2}_{3}_{4}_EUCJP", num, pCodePage->VersionMajor, pCodePage->VersionMinor, pCodePage->VersionRevision, pCodePage->VersionBuild);
	}
