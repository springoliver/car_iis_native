...
public abstract class QualifiedAce : KnownAce
{
	...
	public void SetOpaque(byte[] opaque)
	{
		if (opaque != null)
		{
			...
			{
				throw new ArgumentOutOfRangeException("opaque", string.Format(CultureInfo.CurrentCulture, Environment.GetResourceString("ArgumentOutOfRange_ArrayLength"), 0, MaxOpaqueLengthInternal));
			}
