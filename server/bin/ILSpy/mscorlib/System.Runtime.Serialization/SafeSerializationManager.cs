...
internal sealed class SafeSerializationManager : IObjectReference, ISerializable
{
	...
	private void OnDeserialized(StreamingContext context)
	{
		if (m_realObject != null)
		{
			SerializationEvents serializationEventsForType = SerializationEventsCache.GetSerializationEventsForType(m_realObject.GetType());
			serializationEventsForType.InvokeOnDeserialized(m_realObject, context);
			m_realObject = null;
		}
	}
}
