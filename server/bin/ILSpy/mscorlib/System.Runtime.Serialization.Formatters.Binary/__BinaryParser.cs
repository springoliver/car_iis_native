...
internal sealed class __BinaryParser
{
			...
			while (flag)
			{
				...
				case BinaryTypeEnum.PrimitiveArray:
				{
					...
					case BinaryHeaderEnum.MessageEnd:
						...
						break;
					default:
						throw new SerializationException(Environment.GetResourceString("Serialization_BinaryHeader", b));
					}
					break;
				}
	...
	internal void ReadAssembly(BinaryHeaderEnum binaryHeaderEnum)
	{
		...
		if (binaryHeaderEnum == BinaryHeaderEnum.CrossAppDomainAssembly)
		{
			...
			{
				throw new SerializationException(Environment.GetResourceString("Serialization_CrossAppDomainError", "String", binaryCrossAppDomainAssembly.assemblyIndex));
			}
		}
		else
		{
	...
	private void ReadObject()
	{
		...
		else
		{
			...
			case InternalObjectTypeE.Array:
				...
				break;
			default:
				throw new SerializationException(Environment.GetResourceString("Serialization_Map", objectProgress.objectTypeEnum.ToString()));
			}
		}
	...
	internal void ReadCrossAppDomainMap()
	{
		...
		throw new SerializationException(Environment.GetResourceString("Serialization_CrossAppDomainError", "BinaryObjectMap", obj));
	}
	...
	private void ReadObjectWithMap(BinaryObjectWithMap record)
	{
		...
		else
		{
			...
			case InternalObjectTypeE.Array:
				...
				break;
			default:
				throw new SerializationException(Environment.GetResourceString("Serialization_ObjectTypeEnum", objectProgress.objectTypeEnum.ToString()));
			}
		}
		pr.PRobjectTypeEnum = InternalObjectTypeE.Object;
	...
	private void ReadArray(BinaryHeaderEnum binaryHeaderEnum)
	{
		...
		default:
			throw new SerializationException(Environment.GetResourceString("Serialization_ArrayType", binaryArray.binaryArrayTypeEnum.ToString()));
		}
		if (!flag)
		{
			stack.Push(op);
	...
	internal object ReadValue(InternalPrimitiveTypeE code)
	{
		...
		return code switch
		{
			...
			_ => throw new SerializationException(Environment.GetResourceString("Serialization_TypeCode", code.ToString())), 
		};
	}
