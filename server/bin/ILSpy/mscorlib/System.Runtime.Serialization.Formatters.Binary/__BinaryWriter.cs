...
internal sealed class __BinaryWriter
{
	...
	private void WriteArrayAsBytes(Array array, int typeLength)
	{
		...
		{
			num2 = Math.Min(chunkSize / typeLength, array.Length - i);
			int num3 = num2 * typeLength;
			Buffer.InternalBlockCopy(array, i * typeLength, byteBuffer, 0, num3);
			WriteBytes(byteBuffer, 0, num3);
		}
	}
	...
	internal void WriteValue(InternalPrimitiveTypeE code, object value)
	{
		...
		case InternalPrimitiveTypeE.DateTime:
			...
			break;
		default:
			throw new SerializationException(Environment.GetResourceString("Serialization_TypeCode", code.ToString()));
		}
	}
}
